        ...
        <div className='md:pt-[65px'>
            ...
            >
                <SwiperSlide className='relative'>
                    <img src="https://images.pexels.com/photos/8941567/pexels-photo-8941567.jpeg" alt="" />
                    <div className='absolute font-bold px-20 bg-[#1010105e] h-full w-full flex items-center'>
                ...
                <SwiperSlide className='relative'>
                    <img src="https://images.pexels.com/photos/9207296/pexels-photo-9207296.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
                    <div className='absolute font-bold px-20 bg-[#1010105e] h-full w-full flex items-center'>
                       <div className='text-white md:w-1/2 md:text-left space-y-3 text-center'>
